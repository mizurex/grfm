...
export default function Sidebar({ isMobileMenuOpen, onClose }: SidebarProps) {
  ...
  return (
    <aside
      className={` fixed inset-y-0 left-0  z-50 w-[280px] transform border-r border-gray-200 bg-white transition-transform duration-300 dark:border-slate-700 dark:bg-slate-800 lg:relative lg:translate-x-0 ${
      ...
      <div className="flex h-[88px] items-center justify-between px-6 dark:border-slate-700">
        <div className="flex gap-[12px] ">
          ...
          >
            ...
            <path
              opacity="0.48"
              d="M15.4244 25.3192C15.0551 25.3192 14.71 25.5027 14.5034 25.8088L12.1693 29.2673C11.6713 30.0053 12.2 31 13.0903 31H24.5112C24.8805 31 25.2257 30.8165 25.4322 30.5104L33.8307 18.066C34.3287 17.328 33.8 16.3333 32.9097 16.3333H25.1826C24.8133 16.3333 24.4681 16.5168 24.2616 16.8229L19.3536 24.0953C18.8371 24.8605 17.9743 25.3192 17.0511 25.3192H15.4244Z"
              fill="url(#paint0_linear_353_707)"
            />
            <path
              d="M13.6666 10.0303C14.0744 9.38864 14.7818 9 15.5421 9H24.9773C25.8538 9 26.3852 9.96737 25.9151 10.7071L18.3334 22.6364C17.9256 23.278 17.2182 23.6667 16.4579 23.6667H7.02269C6.14621 23.6667 5.61481 22.6993 6.08494 21.9596L13.6666 10.0303Z"
              fill="url(#paint1_linear_353_707)"
            />
            <defs>
              <linearGradient
                id="paint0_linear_353_707"
                x1="23"
                y1="16.3333"
                x2="23"
                y2="38.5732"
        ...
        <div className="mb-6">
          ...
          <div className="space-y-1">
            ...
            <NavLink
              href="#"
              icon={<CustomersIcon />}
              active={activeNav === "Payments2"}
              onClick={() => setActiveNav("Payments2")}
            >
              Payments
            </NavLink>
            <NavLink
