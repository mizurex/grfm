...
export default function TransactionsCard() {
  ...
  const segment2 = 0.6;
  return (
    <DashboardCard className="w-full lg:w-[352px] h-auto lg:h-[380px] rounded-[16px] border border-primary/20 p-[16px] font-sans">
      ...
      <div className="flex items-center justify-between px-[10px] my-[12px]">
        <div className="border-r pr-[20px]">
          ...
          <div className="flex flex-col text-center">
            <span
              className="text-sm text-[#525866] font-inter"
              style={{ fontWeight: "400" }}
            >
              Shopping
            </span>
            <span className="text-foreground font-medium">$900.00</span>
          </div>
        </div>
        ...
        <div className="border-r pr-[29px]">
          <div className="flex justify-center mb-[12px]">
            ...
            >
              ...
              />
              <path
                d="M22 23.5H10C9.80109 23.5 9.61032 23.421 9.46967 23.2803C9.32902 23.1397 9.25 22.9489 9.25 22.75V9.25C9.25 9.05109 9.32902 8.86032 9.46967 8.71967C9.61032 8.57902 9.80109 8.5 10 8.5H22C22.1989 8.5 22.3897 8.57902 22.5303 8.71967C22.671 8.86032 22.75 9.05109 22.75 9.25V22.75C22.75 22.9489 22.671 23.1397 22.5303 23.2803C22.3897 23.421 22.1989 23.5 22 23.5ZM21.25 22V10H10.75V22H21.25ZM13 12.25H19V13.75H13V12.25ZM13 15.25H19V16.75H13V15.25ZM13 18.25H19V19.75H13V18.25Z"
                fill="#47C2FF"
              />
            </svg>
          </div>
          <div className="flex flex-col text-center">
            ...
            <span className="text-foreground font-medium">$600.00</span>
          </div>
        </div>
        <div>
          <div className="flex justify-center mb-[12px]">
          ...
          <div className="flex flex-col text-center">
            ...
            <span className="text-foreground font-medium">$200.00</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex gap-4 items-center justify-between border border-primary/20 rounded-[8px] pl-[10px] pr-[4px] py-[3px] mt-[20px]">
        <span className="text-sm text-muted-foreground">
          ...
          <span className="text-muted-foreground font-medium"> $20000. </span>
        </span>
